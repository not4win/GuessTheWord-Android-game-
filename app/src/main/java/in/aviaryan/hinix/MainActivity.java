...
public class MainActivity extends AppCompatActivity {
    ...
    public float dpToPixel(float dps){
        final float scale = getApplicationContext().getResources().getDisplayMetrics().density;//gets the density of the display
    ...
    private void initBoard(){
        AssetManager assetManager = getAssets();//instantiate assetmanager
        try {
            // Thanks to
            // https://github.com/ManiacDC/TypingAid/tree/master/Wordlists
            InputStream inputStream = assetManager.open("wordlist_English_Gutenberg.txt");//inputstream reads contents of the file
